...
数据集信息:
  - 总条数: 129 条
  - 相机: cam_high (顶部), cam_right_wrist (右腕)
...
REPO_ID = "local/right_arm_8d"

# OpenPI 模型期望的相机槽位顺序（3个，left_wrist使用占位符）
...
#   cam_right_wrist → right_wrist_0_rgb(第2槽位：右腕相机)
IMAGE_KEYS = (
...
class MyRobotInputs(_transforms.DataTransformFn):
    ...
    State: 8 维 (右臂 7关节 + 1灵巧手)
    Action: 8 维 (右臂动作)
    """
    image_keys: Sequence[str] = ("cam_high", "cam_right_wrist")
