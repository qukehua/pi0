...
使用方法:
    ...
    CUDA_VISIBLE_DEVICES=0 /share/0xyj/model3_openpi0.5/openpi-main/.venv/bin/python3.11 \
        /share/0xyj/model3_openpi0.5/my_pi0_training/train_right_arm.py \
        pi0_right_arm_8d --exp_name=right_arm_v1

目录结构:
    /share/0xyj/model3_openpi0.5/
    ├── openpi-main/            # 官方仓库（不修改）
    ├── my_pi0_training/        # 本训练模块（当前目录）
    │   ├── train_right_arm.py  # 本文件
    │   ├── my_config_right_arm.py  # 训练配置
